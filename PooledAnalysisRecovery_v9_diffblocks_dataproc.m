...
% that box/mouse, *****the mouse with an entry of 1 must be in the same location
% in both blocks of trial*****
run_analysis=[0 0 0 0 1];
...
%---------------------------------------
runsave_pooled_analysis_5box_toneonly_blank_regen_diffblocks(rawdatafiles_all, ActiveBoxes, MouseTags, time_params, datadir, datasavedir, figdir_pool, SessionTag, TypeTrial, [], [], [], email, timetag_ids,run_analysis)
